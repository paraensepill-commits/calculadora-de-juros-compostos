...
export const InfoSection: React.FC = () => {
  return (
    <div className="mt-16 max-w-4xl mx-auto space-y-12 text-gray-700 leading-relaxed">
      ...
      <section className="bg-white p-8 rounded-xl shadow-sm border border-[#1877F2]/20">
        <h2 className="text-2xl font-bold text-[#1877F2] mb-6 border-b border-[#1877F2]/20 pb-4">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 mt-4">
            <li className="flex items-start">
              <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-[#1877F2]/10 text-[#1877F2] font-bold text-xs mr-3 mt-1">1</span>
              <span><strong>Valor Inicial:</strong> Insira o montante que você já possui guardado para começar o investimento.</span>
            </li>
            <li className="flex items-start">
              <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-[#1877F2]/10 text-[#1877F2] font-bold text-xs mr-3 mt-1">2</span>
              <span><strong>Aporte Mensal:</strong> Defina quanto você consegue poupar e investir todos os meses.</span>
            </li>
            <li className="flex items-start">
              <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-[#1877F2]/10 text-[#1877F2] font-bold text-xs mr-3 mt-1">3</span>
            ...
            <li className="flex items-start">
              <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-[#1877F2]/10 text-[#1877F2] font-bold text-xs mr-3 mt-1">4</span>
      ...
      {/* Formula Explanation */}
      <section>
        <h2 className="text-2xl font-bold text-[#1877F2] mb-4">A Matemática dos Juros Compostos</h2>
        <p className="mb-4">
        ...
        <div className="bg-[#1877F2] text-white p-6 rounded-lg font-mono text-center my-6 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="bg-white p-4 rounded shadow-sm border-l-4 border-[#1877F2]/50">
      ...
      <section className="grid md:grid-cols-2 gap-8">
        <div>
          <h3 className="text-xl font-bold text-[#1877F2] mb-3">Juros Simples</h3>
        ...
        <div>
          <h3 className="text-xl font-bold text-[#1877F2] mb-3">Juros Compostos</h3>
          <p className="text-gray-600 mb-4">
      ...
      {/* Contexts */}
      <section className="bg-[#1877F2]/5 p-8 rounded-xl border border-[#1877F2]/20">
        <h2 className="text-2xl font-bold text-[#1877F2] mb-4">Onde eles estão presentes?</h2>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-5 rounded-lg shadow-sm border border-[#1877F2]/20">
            <h4 className="font-bold text-[#1877F2] mb-2">Investimentos</h4>
            <p className="text-sm">
          ...
          <div className="bg-white p-5 rounded-lg shadow-sm border border-[#1877F2]/20">
             <h4 className="font-bold text-[#1877F2] mb-2">Dívidas</h4>
             <p className="text-sm">
          ...
          <div className="bg-white p-5 rounded-lg shadow-sm border border-[#1877F2]/20">
             <h4 className="font-bold text-[#1877F2] mb-2">Financiamentos</h4>
             <p className="text-sm">
